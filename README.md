...
_Se desarrolla la primer pre entrega para el curso de Coderhouse: React para que los estudiantes tengan a modo de ejemplo_ 

## Comenzando 🚀

_La idea es que los alumnos tengan una guia para realizar la primer preentrega del proyecto_
...
```
git clone https://github.com/rod77/CH_primera_pre_entrega.git
```
...
https://primera-pre-entrega.vercel.app/
